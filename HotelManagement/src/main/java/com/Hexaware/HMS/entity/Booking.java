...
public class Booking {
     ...
     */
    public Booking(int bookingId, int guestId, int roomId, int hotelId, int noOfGuests, int totalDays, String discount,
    ...
    public String toString() {
        return "Booking [bookingId=" + bookingId + ", guestId=" + guestId + ", roomId=" + roomId + ", hotelId="
                + hotelId + ", noOfGuests=" + noOfGuests + ", totalDays=" + totalDays + ", discount=" + discount
